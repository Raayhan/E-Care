                                            ...
                                            <a href="/patient/department/all">
                                                <div class="text-white rounded d-flex h-100 mask  indigo darken-3">
                                                    <div class="first-content align-self-center p-3">
                                                        ...
                                                        <p class="text-center">Make an appointment with doctor by
                                                            browsing different departments of E-Care</p>
                                                    </div>
                                            ...
                                            <a href="/patient/doctors/all">
                                                <div class="text-white d-flex rounded h-100 mask  red darken-4">
                                                    <div class="first-content align-self-center p-3">
                                                        ...
                                                        <p class="text-center">Find all doctors or search and select
                                                            your desired doctor to make an appointment.</p>
                                                    </div>
