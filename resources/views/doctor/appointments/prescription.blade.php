                            ...
                            <div class="card-body branch_add">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4 prescription">
                                        <span class="h5 text-danger">Dr.
                                            {{ Auth::guard('doctor')->user()->name }}</span><br>
                                        <span>{{ Auth::guard('doctor')->user()->designation }}</span><br>
                                        <span>Department of
                                            {{ Auth::guard('doctor')->user()->department }}</span><br>
                                        <span>{{ Auth::guard('doctor')->user()->degree }}</span><br>
                                        <span>BMDC REG No. :
                                            {{ Auth::guard('doctor')->user()->reg_no }}</span><br>
                                    ...
                                    <div class="col-md-4">
                                        <div class="row justify-content-center">
                                            <form action="/doctor/appointments/checkout" method="get">
                                                ...
                                                <button style="font-size:11px!important;" type="submit"
                                                    class=" btn btn-unique">Checkout <i
                                ...
                                <form action="/doctor/appointments/prescription" method="POST">
                                    ...
                                    <fieldset class="form-group">
                                        <div class="row">
                                            <legend class="col-form-label col-md-4 text-md-right font-weight-bold pt-0">
                                                Type</legend>
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type" id="tab"
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type" id="cap"
                                                        value="Capsule">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type" id="liq"
                                                        value="Liquid">
                                    ...
                                    <div class="form-group row">
                                        <label for="dosage"
                                            class="col-md-4 col-form-label text-md-right font-weight-bold">{{ __('Dosage') }}</label>
                                    ...
                                    <fieldset class="form-group">
                                        <div class="row">
                                            <legend class="col-form-label col-md-4 text-md-right pt-0 font-weight-bold">
                                                Frequency</legend>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="duration"
                                            class="col-md-4 col-form-label text-md-right font-weight-bold">{{ __('Duration') }}</label>
